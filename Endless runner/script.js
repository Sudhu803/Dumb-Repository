...
function PlatformManager(){
  ...
  this.colors = ['red', 'yellow', 'blue', 'pink','green'];
...
InfiniteRunner.setup = function () {
  ...
  this.player = new Player({x: 150, y: 40, width: 40, height: 35  });

  this.platformManager = new PlatformManager();

  this.particles = [];
  this.particlesIndex = 0;
  this.particlesMax = 20000;
...
InfiniteRunner.draw = function(){
  ...
  this.font = '17pt Commic Snas MS';
  this.fillStyle = 'green';
  this.fillText('HIGH: '+this.jumpCountRecord, this.width - (150 + (this.aceleration * 4)), 33 - (this.aceleration * 4));
  this.fillStyle = 'yellow';
  this.font = (15 + (this.aceleration * 3))+'pt Commic Snas MS';
